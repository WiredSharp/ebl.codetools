...
namespace SemanticVersioning
{
    ...
    public class NugetVersionProvider: IVersionProvider
    {
        ...
        :this(repositoryAddress, NopLogger.Logger)
        {
        }

        public NugetVersionProvider(string repositoryAddress, ILogger logger)
        {
        ...
        public async Task<SemanticVersion> GetNextVersionAsync(string packageId, CancellationToken cancellationToken)
        {
            ...
            {
                return new SemanticVersion(lastVersion.Major, lastVersion.Minor, lastVersion.Patch + 1, lastVersion.Release, null);
            }
        }
